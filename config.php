 ...
 */
 $config = array(
	...
	'key'=>'ca07caa8a8', 
	'category_api'=>'http://gbm.webike.net/cm-api-stg/api/categories-public', 
	'post_api'=>'http://gbm.webike.net/cm-api-stg/api/posts-public/allv2', 
 );
...
class Database
{
    ...
    */
	...
	public function Curl($url,$parameters = NULL,$headers = array())
	{
		$curl = curl_init();
